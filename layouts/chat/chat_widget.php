...
<script>
  const isCustomerLoggedIn = <?php echo json_encode($is_customer_logged_in_for_chat); ?>;
  let chatSessionId = <?php echo json_encode($chat_session_id_from_php); ?>;
</script>

<script src="./layouts/chat/js/chat-ui.js"></script>
<script src="./layouts/chat/js/koneksi-api-chat.js"></script>
<script src="./layouts/chat/js/chatbot.js"></script>