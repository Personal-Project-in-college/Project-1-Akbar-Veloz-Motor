      ...
      <div id="Deskripsi" class="tabcontent" style="display: block;">
        <div class="avm-detail-content font-Poppins">
          ...
          <div class="avm-specs">
            ...
            <table>
              <tr><th>Tipe Mesin</th><td><?php echo htmlspecialchars($vehicle['cc_engine']); ?>cc, 4-Langkah, SOHC, <?php echo htmlspecialchars(ucfirst($vehicle['type_fuel'])); ?></td></tr>
              <tr><th>Tahun</th><td><?php echo date('Y', strtotime($vehicle['production_year'])); ?></td></tr>
              <tr><th>Kilometer</th><td><?php echo number_format($vehicle['kilometer']); ?> Km</td></tr>
              <tr><th>Warna</th><td><?php echo htmlspecialchars($vehicle['color']); ?></td></tr>
              <tr><th>Masa Berlaku STNK</th><td><?php echo date('d F Y', strtotime($vehicle['stnk_deadline'])); ?></td></tr>
            </table>
