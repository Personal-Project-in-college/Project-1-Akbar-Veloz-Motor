...
<head>
    ...
    <link rel="stylesheet" href="./views/pages/user/css/style.css" />
...
<body>
    <?php include("./views/pages/user/navbar.php"); ?>
    ...
    <!-- Footer -->
    <?php include("./views/pages/user/footer.php"); ?>

    <script src="./views/pages/user/js/global.js"></script>
    <script src="./views/pages/user/js/script.js"></script>
</body>
