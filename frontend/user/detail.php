...
<body>
    ...
    <main class="container">
        <section class="avm-vehicle-detail">
            <h2>Honda Beat 2020 CBS ISS 110cc FI AT Merah • Green on Black</h2>
            ...
            <div class="avm-gallery">
              ...
              <div class="avm-thumbnails">
                <img src="./assets/images/kendaraan/image.jpg" alt="Thumbnail 1" class="avm-thumbnail" data-index="2">
                <img src="./assets/images/kendaraan/image2.jpg" alt="Thumbnail 2" class="avm-thumbnail" data-index="3">
                <img src="./assets/images/kendaraan/image3.png" alt="Thumbnail 3" class="avm-thumbnail" data-index="4">
                <img src="./assets/images/kendaraan/image4.png" alt="Thumbnail 4" class="avm-thumbnail" data-index="5">
              </div>
            </div>
            ...
            <div class="avm-specs-grid">
              <div class="avm-spec-item"><strong>Tahun kendaraan</strong><p>2020</p></div>
              <div class="avm-spec-item"><strong>Kilometer</strong><p>20.000</p></div>
              <div class="avm-spec-item"><strong>Warna</strong><p>Green on Black</p></div>
              <div class="avm-spec-item"><strong>CC</strong><p>110cc</p></div>
            </div>
      
            <div class="avm-detail-content font-Poppins">
              <div class="avm-description">
                <div class="harga color-orange">Harga: Rp 14.500.000</div>
              ...
              <div class="avm-specs">
                ...
                <table>
                  <tr><th>Tipe Mesin</th><td>110cc, 4-langkah, SOHC, PGM-FI</td></tr>
                  <tr><th>Daya Maksimum</th><td>6.38 kW (8.7 PS) / 7.500 rpm</td></tr>
                  <tr><th>Torsi Maksimum</th><td>9.3 Nm / 5.500 rpm</td></tr>
                  <tr><th>Sistem Transmisi</th><td>Otomatis, V-Matic</td></tr>
                  <tr><th>Sistem Pengereman</th><td>CBS (Combi Brake System)</td></tr>
                  <tr><th>Kapasitas Tangki</th><td>4.2 liter</td></tr>
                  <tr><th>Berat Kosong</th><td>93 kg</td></tr>
                </table>
      
                <div class="avm-action-buttons">
                    <div class="avm-wrap-btn">
                  <button type="button" class="avm-btn-primary">
                    <svg
                    width="30px"
                    height="30px"
                    viewBox="0 0 24 24"
                  ...
                  >
                    ...
                    Tes Drive</button>
                  <button type="button" class="avm-btn-primary">
                  <svg  width="25px" height="25px" viewBox="0 0 16.00 16.00" xmlns="http://www.w3.org/2000/svg"  stroke-width="0.00016"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M11.42 9.49c-.19-.09-1.1-.54-1.27-.61s-.29-.09-.42.1-.48.6-.59.73-.21.14-.4 0a5.13 5.13 0 0 1-1.49-.92 5.25 5.25 0 0 1-1-1.29c-.11-.18 0-.28.08-.38s.18-.21.28-.32a1.39 1.39 0 0 0 .18-.31.38.38 0 0 0 0-.33c0-.09-.42-1-.58-1.37s-.3-.32-.41-.32h-.4a.72.72 0 0 0-.5.23 2.1 2.1 0 0 0-.65 1.55A3.59 3.59 0 0 0 5 8.2 8.32 8.32 0 0 0 8.19 11c.44.19.78.3 1.05.39a2.53 2.53 0 0 0 1.17.07 1.93 1.93 0 0 0 1.26-.88 1.67 1.67 0 0 0 .11-.88c-.05-.07-.17-.12-.36-.21z"></path><path d="M13.29 2.68A7.36 7.36 0 0 0 8 .5a7.44 7.44 0 0 0-6.41 11.15l-1 3.85 3.94-1a7.4 7.4 0 0 0 3.55.9H8a7.44 7.44 0 0 0 5.29-12.72zM8 14.12a6.12 6.12 0 0 1-3.15-.87l-.22-.13-2.34.61.62-2.28-.14-.23a6.18 6.18 0 0 1 9.6-7.65 6.12 6.12 0 0 1 1.81 4.37A6.19 6.19 0 0 1 8 14.12z"></path></g></svg>
                    Whatsapp</button>
                </div>
                  <button type="button" class="avm-btn-secondary" onclick="addToWishlist()">
