...
$getPartnerQuery = $koneksi->prepare("SELECT * FROM customers WHERE deleted_at IS NULL AND (name LIKE ? OR phone LIKE ? OR email LIKE ?) ORDER BY created_at ASC");
$getPartnerQuery->execute([$keyword, $keyword, $keyword]);
