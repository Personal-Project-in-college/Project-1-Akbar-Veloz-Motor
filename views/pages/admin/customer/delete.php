...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="d-flex align-items-center flex-wrap mb-3 gap-2">
            ...
            <div class="flex-grow-1 d-flex align-items-center" style="min-width: 250px;">
                <input type="text" class="form-control rounded-pill" id="search-input" placeholder="Cari Pelanggan Terhapus(Nama, Telepon, Email)...">
            </div>
        </div>

        <ul class="nav nav-tabs mb-3">
            <li class="nav-item">
                <a class="nav-link text-primary <?= ($activePage == 'customer.php') ? 'active' : '' ?>" href="customer.php">Data Aktif</a>
            </li>
            <li class="nav-item">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content shadow rounded-4 border-0">
                    <div class="modal-body text-center p-5">
                        ...
                        <h5 class="fw-bold text-danger mb-3" id="confirmDeleteModalLabel">Hapus Pelanggan Secara Permanen?</h5>
    ...
    <script>
        ...
        const tableBody = document.getElementById('deletedCustomerTableBody');

        function loadDeletedCustomers(keyword = '') {
            fetch(`ajaxCustomerDeletedList.php?keyword=${encodeURIComponent(keyword)}`)
                .then(res => res.text())
                .then(html => {
        ...
        searchInput.addEventListener('keyup', function() {
            loadDeletedCustomers(this.value);
        });
    </script>
            ...
            document.querySelectorAll('.restore-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    fetch('restore.php', {
                        ...
                        .then(data => {
                            if (data.success) {
                                loadDeletedCustomers(); // reload tabel
...
<!-- Modal Show KTP -->
<div class="modal fade" id="modalShowKtp" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Scan KTP Partner</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body text-center">
                <img id="ktpImage" src="" alt="KTP Partner" class="img-fluid rounded shadow" style="max-height: 500px;">
            </div>
        </div>
    </div>
</div>
...
<!-- Modal Show KTP -->
<div class="modal fade" id="modalShowPhoto" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Foto Partner</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body text-center">
                <img id="photoImage" src="" alt="Photo Partner" class="img-fluid rounded shadow" style="max-height: 500px;">
            </div>
        </div>
    </div>
</div>