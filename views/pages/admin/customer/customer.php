...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="d-flex align-items-center flex-wrap mb-3 gap-2">
            ...
            <div class="flex-grow-1 d-flex align-items-center" style="min-width: 250px;">
                <input type="text" class="form-control rounded-pill" id="search-input" placeholder="Cari Pelanggan (Nama, Telepon, Email)...">
            </div>
        </div>
    ...
    <script>
        ...
        function loadCustomers(keyword = '') {
            fetch(`ajaxCustomerList.php?keyword=${encodeURIComponent(keyword)}`)
                .then(res => res.text())
                .then(html => {
