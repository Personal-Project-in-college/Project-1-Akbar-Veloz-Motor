...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <ul class="nav nav-tabs mb-3">
            <li class="nav-item">
                <a class="nav-link text-primary <?= ($activePage == 'partner.php') ? 'active' : '' ?>" href="partner.php">Data Aktif</a>
            </li>
            <li class="nav-item">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content shadow rounded-4 border-0">
                    <div class="modal-body text-center p-5">
                        ...
                        <h5 class="fw-bold text-danger mb-3" id="confirmDeleteModalLabel">Hapus Partner Secara Permanen?</h5>
