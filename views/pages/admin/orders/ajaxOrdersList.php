    ...
    foreach ($data as $row) {
        ...
        echo "<tr>
                ...
                <td style='display: flex; align-items: center; gap: 8px;'>
                    <a href='detail.php?id={$orderId}' title='Detail' class='btn btn-dark btn-sm d-flex justify-content-center align-items-center' style='width: 28px; height: 28px; border-radius: 4px;'>
