...
if ($transactions) {
    foreach ($transactions as $row) {
        ...
        // ✅ Cek null atau 0 pada grand_total
        ...
        echo "<td>{$row['payment_type']}</td>
                ...
                <a href='detail.php?id={$row['id']}' title='Detail' class='btn btn-dark btn-sm d-flex justify-content-center align-items-center' style='width: 28px; height: 28px; border-radius: 4px; color: white'>
