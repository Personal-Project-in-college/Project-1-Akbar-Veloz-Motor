    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex align-items-center flex-wrap mb-3 gap-2">
            ...
            <div class="flex-grow-1 d-flex align-items-center" style="min-width: 250px;">
                <input type="text" class="form-control rounded-pill" id="search-input" placeholder="Cari Peminjam Terhapus (Kode Kendaraan, Name)...">
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content shadow rounded-4 border-0">
                    <div class="modal-body text-center p-5">
                        ...
                        <h5 class="fw-bold text-danger mb-3" id="confirmDeleteModalLabel">Hapus Peminjaman Secara Permanen?</h5>
