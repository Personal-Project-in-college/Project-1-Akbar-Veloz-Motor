...
$getDeleteRoleQuery = $koneksi->prepare("SELECT * FROM roles WHERE deleted_at IS NOT NULL AND name LIKE ? ORDER BY name DESC");
$getDeleteRoleQuery->execute([$keyword]);
$data = $getDeleteRoleQuery->fetchAll(PDO::FETCH_ASSOC);
