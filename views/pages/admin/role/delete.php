    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex align-items-center flex-wrap mb-3 gap-2">
            ...
            <div class="flex-grow-1 d-flex align-items-center" style="min-width: 250px;">
                <input type="text" class="form-control rounded-pill" id="search-input" placeholder="Cari Jabatan Terhapus (Nama)...">
            </div>
        </div>

        <ul class="nav nav-tabs mb-3">
            <li class="nav-item">
                <a class="nav-link text-primary <?= ($activePage == 'role.php') ? 'active' : '' ?>" href="role.php">Data Aktif</a>
            </li>
            <li class="nav-item">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content shadow rounded-4 border-0">
                    <div class="modal-body text-center p-5">
                        ...
                        <h5 class="fw-bold text-danger mb-3" id="confirmDeleteModalLabel">Hapus Jabatan Secara Permanen?</h5>
