...
$getBranchQuery = $koneksi->prepare("SELECT * FROM branches WHERE deleted_at IS NULL AND (name LIKE ? OR address LIKE ?) ORDER BY created_at ASC");
$getBranchQuery->execute([$keyword, $keyword]);
